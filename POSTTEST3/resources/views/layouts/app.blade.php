    ...
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
      ...
      <div class="flex items-center gap-4">
        <nav class="hidden md:flex items-center gap-4">
          ...
          <a href="{{ route('articles.index') }}" <a href="{{ route('articles.index') }}"
            class="text-sm text-gray-700 dark:text-gray-300 hover:underline">Berita</a>
          <a href="{{ route('veterinary.records') }}"
            class="text-sm text-gray-700 dark:text-gray-300 hover:underline">Rekam Medis</a>
          <a href="{{ route('about') }}" class="text-sm text-gray-700 dark:text-gray-300 hover:underline">About</a>
          <a href="{{ route('contact.create') }}"
            class="text-sm text-gray-700 dark:text-gray-300 hover:underline">Contact</a>
        </nav>
