...
<div class="group overflow-hidden rounded-3xl border border-white/10 bg-slate-900/70 shadow-xl shadow-black/40 transition duration-300 hover:-translate-y-1 hover:border-emerald-400/40 hover:shadow-emerald-500/20">
    <div class="relative h-48 w-full overflow-hidden">
        <?php if($animal->image_url): ?>
            <img src="<?php echo e($animal->image_url); ?>" alt="<?php echo e($animal->name); ?>" class="h-full w-full object-cover">
        <?php else: ?>
        ...
        <div class="absolute inset-x-0 bottom-0 flex items-center justify-between px-5 pb-4">
            <span class="rounded-full border border-white/20 bg-white/15 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-white"><?php echo e($animal->species); ?></span>
            <span class="text-xs text-slate-200/80">ID #<?php echo e($animal->id); ?></span>
        </div>
    </div>

    <div class="space-y-4 p-6">
        <div class="min-w-0 space-y-1">
            <h3 class="truncate text-xl font-semibold text-white"><?php echo e($animal->name); ?></h3>
            <p class="text-sm text-slate-300/80"><?php echo e($animal->breed ?? 'Breed belum ditentukan'); ?></p>
        </div>

        <p class="text-sm leading-relaxed text-slate-300/80"><?php echo e($animal->description); ?></p>
        ...
        <div class="grid grid-cols-2 gap-3 text-xs text-slate-200">
            <div class="rounded-2xl border border-white/10 bg-white/5 p-3">
                ...
                <div class="mt-1 flex items-center gap-1.5 text-sm">
                    ...
                    <span class="font-medium text-white"><?php echo e($animal->age); ?></span> tahun
                </div>
                <span class="mt-2 inline-flex items-center rounded-full border <?php echo e($animal->age >= 5 ? 'border-amber-400/30 bg-amber-400/10 text-amber-200' : 'border-emerald-400/30 bg-emerald-400/10 text-emerald-200'); ?> px-2.5 py-1 text-[11px] font-semibold">
                    <?php echo e($animal->age >= 5 ? 'Usia senior' : 'Usia muda'); ?>
            ...
            <div class="rounded-2xl border border-white/10 bg-white/5 p-3">
                ...
                <div class="mt-1 flex items-center gap-1.5 text-sm">
                    ...
                    <span class="font-medium text-white"><?php echo e($medicalCount); ?></span>
                    <span>riwayat</span>
                </div>
...
<?php /**PATH C:\xampp\htdocs\Posttest\Posttest4\resources\views/components/animal-card.blade.php ENDPATH**/ ?>