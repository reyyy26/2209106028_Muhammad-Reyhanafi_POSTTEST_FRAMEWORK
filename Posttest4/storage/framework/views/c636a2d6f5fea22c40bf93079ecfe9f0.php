<?php $__env->startSection('title', 'About Nyxx Farm'); ?>
...
<div class="space-y-10">
    ...
    <section class="panel space-y-4">
        <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <a href="<?php echo e(route('contact.create')); ?>" class="button-primary">Buka Form Kontak</a>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Posttest\Posttest4\resources\views/about.blade.php ENDPATH**/ ?>